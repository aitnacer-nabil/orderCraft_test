...
public class ProductServiceImplTest {
    ...
    @CsvFileSource(resources = "/product.csv", numLinesToSkip = 1, delimiter = ',')
    void shouldTestPhoneNumberFormatUsingCSVFileSource(String name, String description, String price, int qteStock,int qteSales) {
